...
#   bash src/nav_vla_pkg/scripts/collect_lane_change.sh
#
# Output: a new src/nav_vla_pkg/data/session_<stamp>/ with lane-changing episodes.
#
...
ros2 run nav_vla_pkg data_engine_node --ros-args \
  -p nav_mode:=lane \
