...
Run instead of navigator_node:
    ...
    ros2 run nav_vla_pkg policy_node
"""
...
from nav_vla_pkg.speed_control import clamp_speed_raw
...
DEFAULT_CKPT = os.path.expanduser(
    "~/ROS2_project/nav-vla/src/nav_vla_pkg/train/checkpoints/stage_a.pt"
)
