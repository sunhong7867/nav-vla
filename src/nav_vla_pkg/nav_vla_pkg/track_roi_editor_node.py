...
Usage:
    ros2 run nav_vla_pkg track_roi_editor_node
    ros2 run nav_vla_pkg track_roi_editor_node --ros-args \
...
DEFAULT_OUT = os.path.expanduser(
    "~/ROS2_project/nav-vla/src/nav_vla_pkg/config/track_rois.json"
)
ROLES = ["출발", "재위치", "정차", "종료"]
