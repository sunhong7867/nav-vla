...
Usage:
    ros2 run nav_vla_pkg action_sentence_generator
    ros2 run nav_vla_pkg action_sentence_generator -- --count 600
    python3 src/nav_vla_pkg/nav_vla_pkg/action_sentence_generator.py --count 600
"""
...
DEFAULT_OUT_DIR = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/data_actions")
