...
Usage:
    python3 src/nav_vla_pkg/train/train_obstacle.py
    python3 src/nav_vla_pkg/train/train_obstacle.py --epochs 15 --img 128
"""
...
DATA_ROOT = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/data_obstacle")
