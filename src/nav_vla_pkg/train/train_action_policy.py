...
Usage:
    python3 src/nav_vla_pkg/train/train_action_policy.py
    python3 src/nav_vla_pkg/train/train_action_policy.py --epochs 100
    python3 src/nav_vla_pkg/train/train_action_policy.py --data path/to/samples.jsonl
"""
...
from nav_vla_pkg.action_policy_model import (  # noqa: E402
    MAX_STEPS,
    ActionPolicyNet,
    build_vocabs,
    encode_text,
...
DATA_ROOT = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/data_actions")
