...
Usage:
    python3 src/nav_vla_pkg/train/train_stage_a.py
    python3 src/nav_vla_pkg/train/train_stage_a.py --epochs 30 --img 128
    python3 src/nav_vla_pkg/train/train_stage_a.py --sessions session_20260702_lane1,2
"""
...
DATA_ROOT = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/data")
ZONE_MAP = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/config/zone_map.yaml")
OUT_DIR = os.path.expanduser("~/ROS2_project/nav-vla/src/nav_vla_pkg/train/checkpoints")
DIRECT_ONLY_ZONES = {
    "IN",
    "OUT(통과직전)",
    "OUT(통과직후)",
